...
import type { ILinkNodeWidget, IWidgetOptions } from "../types/widgets"

import { BaseWidget, type DrawWidgetOptions } from "./BaseWidget"

export class LinkNodeWidget extends BaseWidget implements ILinkNodeWidget {
  // ILinkNodeWidget properties
  ...
  constructor(widget: ILinkNodeWidget) {
    super(widget)
    this.type = "linknode"
