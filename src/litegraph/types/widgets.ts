...
export interface IWidgetccNodeOptions extends IWidgetOptions<number> {
  viewWidth: number
  viewHeight: number
}


export interface IWidgetcurveOptions extends IWidgetOptions<number> {
  viewWidth: number
  viewHeight: number
}
...
export interface ILinkNodeWidgetOptions extends IWidgetOptions<number> {
...
export interface ILinkNodeWidget extends IBaseWidget {
  type: "linknode"
  value: undefined
  clicked: boolean
}
...
export interface IccNodeWidget extends IBaseWidget {
  type: "ccnode"
  value: object
  options: IWidgetccNodeOptions
}

//贝塞尔曲线编辑组件
export interface IcurveWidget extends IBaseWidget {
  type: "curve"
  value: object
  options: IWidgetcurveOptions
}
